...
export const metadata: Metadata = {
  ...
  description:
    'Start free or upgrade to StickStory Pro. Generate unlimited stickman explainer videos, lofi music, ASMR songs, and cartoon videos with AI. Cancel anytime.',
  keywords: [
  ...
  openGraph: {
    title: 'Pricing | StickStory — AI Video Generator',
    description: 'Free and Pro plans for AI video generation. Stickman videos, lofi music, ASMR & cartoon content. Cancel anytime.',
    url: `${SEO.siteUrl}/pricing`,
    images: [{ url: SEO.defaults.ogImage, width: 1200, height: 630, alt: 'StickStory Pricing' }],
  },
}

  ...
  return (
    <section className="w-full bg-background px-4 md:px-12 py-10" id="puppy-interactive-section">
      <div className="max-w-7xl mx-auto">
        <div className="relative w-full rounded-[32px] bg-gradient-to-br from-pink-blush via-softpink to-pink-rose p-4 sm:p-12 md:p-16 overflow-hidden flex flex-col justify-center items-center h-[520px] md:h-[580px] shadow-2xl border border-pink-border">
          ...
          <div className="absolute top-6 left-6 z-20 bg-coral hover:bg-coral/95 text-white p-1 rounded-full shadow-lg flex items-center gap-2 border border-border">
          ...
          <div className="absolute bottom-6 left-6 right-6 sm:left-auto sm:right-auto sm:w-[500px] z-25">
            ...
            >
              <div className="flex items-center gap-3.5 pl-4 flex-grow">
                <span className={`w-2.5 h-2.5 rounded-full ${isGenerating ? "bg-coral animate-ping" : "bg-muted-foreground/40"}`} />
                <input
                  type="text"
                  value={promptValue}
              ...
              <button
                type="submit"
                disabled={isGenerating}
                className="px-5 py-2.5 bg-foreground hover:bg-coral text-background hover:text-white text-xs font-bold uppercase tracking-wider rounded-full transition-all duration-300 transform active:scale-95 flex items-center gap-1.5 flex-shrink-0 cursor-pointer disabled:opacity-50"
              >

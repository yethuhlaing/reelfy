...
export default function Hero() {
  return (
    <header className="relative w-full min-h-screen bg-cream overflow-hidden flex flex-col justify-end pt-32 pb-16 md:pb-24" id="hero-section">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 relative flex flex-col justify-between flex-grow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start z-10 w-full mb-12">
          ...
          <div className="md:col-span-4 max-w-sm flex flex-col gap-1.5 pt-4">
            <span className="font-mono text-xs font-semibold text-dark tracking-widest uppercase">
              01 —
            </span>
            <p className="text-dark/80 text-xs md:text-sm font-normal leading-relaxed">
          ...
          <div className="md:col-span-4 flex md:justify-end">
            <motion.div
              ...
              className="bg-softpink text-dark border border-dark/5 px-6 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider shadow-sm hover:scale-105 transition-transform cursor-pointer flex items-center gap-2"
            >
        ...
        <div className="relative w-full flex flex-col items-center justify-center py-8 my-auto select-none">
          ...
          <h1 className="font-display font-black text-center text-[11vw] sm:text-[120px] md:text-[145px] lg:text-[160px] leading-[0.85] tracking-tighter text-dark select-none pointer-events-none flex flex-col items-center z-0 uppercase">
          ...
          <div className="absolute left-1/2 top-[52%] -translate-x-1/2 -translate-y-1/2 w-[260px] sm:w-[320px] md:w-[380px] lg:w-[420px] h-[310px] sm:h-[380px] md:h-[450px] lg:h-[490px] z-10 select-none pointer-events-none">
            ...
            <div 
              ...
              style={{
                backgroundImage: "url('https://images.pexels.com/photos/1181682/pexels-photo-1181682.jpeg?auto=compress&cs=tinysrgb&w=600')",
            ...
            >
              ...
              <div className="absolute inset-0 grid grid-cols-6 gap-y-7 gap-x-6 sm:gap-y-9 sm:gap-x-8 px-8 sm:px-12 pt-16 pb-8 opacity-75 pointer-events-none">
                {Array.from({ length: 36 }).map((_, i) => (
                  <span key={i} className="text-coral font-bold text-xs sm:text-sm flex items-center justify-center" style={{ textShadow: "0 0 4px rgba(255, 90, 60, 0.4)" }}>
                    +
                  </span>
                ))}
              </div>
          ...
          <motion.div
            ...
            className="absolute left-4 sm:left-12 top-[45%] -translate-y-1/2 z-20 bg-coral text-white border border-white/10 px-6 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider shadow-lg hover:scale-105 transition-transform cursor-pointer flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end w-full mt-8 z-20">
          ...
          <div className="md:col-span-4 max-w-sm flex items-start gap-4">
            <div className="relative flex-shrink-0 w-11 h-11 bg-dark rounded-full flex items-center justify-center border border-dark/10 shadow-sm">
              <span className="w-4 h-4 rounded-full bg-coral relative">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-dark/90 text-xs md:text-sm font-normal leading-relaxed">

    ...
    <section className="w-full bg-background grid grid-cols-1 md:grid-cols-3 border-y border-border" id="stats-section">
        ...
        <div className="my-6">
          ...
          <div className="relative w-full h-11 bg-white/20 rounded-full border border-white/15 p-1 flex items-center">
            ...
            <div 
              ...
              className="absolute top-1/2 -translate-y-1/2 w-9 h-9 bg-foreground rounded-full flex items-center justify-center text-background transition-all duration-350 shadow-md group-hover:scale-110 pointer-events-none"
            >
      ...
      <div className="bg-mint p-10 min-h-[350px] flex flex-col justify-between group transition-colors duration-300 text-foreground">
        <div>
          ...
          <div className="relative w-full h-11 bg-foreground/10 rounded-full border border-foreground/10 p-1 flex items-center">
            <div 
              style={{ width: `${percent2}%` }}
              className="h-full bg-foreground/15 rounded-full transition-all duration-350 ease-out" 
            />
        ...
        <div>
          <p className="text-foreground/90 text-sm font-medium leading-relaxed max-w-sm">
      ...
      <div className="bg-softpink p-10 min-h-[350px] flex flex-col justify-between group transition-colors duration-300 text-foreground">
        ...
        <div>
          ...
          <div className="relative w-full h-11 bg-white/30 rounded-full border border-foreground/10 p-1 flex items-center">
            <div 

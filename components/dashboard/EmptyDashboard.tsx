...
export function EmptyDashboard({ category }: { category: string }) {
  return (
    <div className="flex flex-col items-center gap-[18px] rounded-[18px] border border-dashed border-[var(--border)] bg-[color-mix(in_srgb,var(--surface)_80%,transparent)] px-5 py-[60px] text-center">
      <StickmanArt />
      <h3 className="font-[var(--font-heading)] text-2xl">Bring your story to life</h3>
      <p className="max-w-[420px] text-[var(--muted)]">Drop a story, press generate, and watch stickman scenes auto-animate with voiceover.</p>
